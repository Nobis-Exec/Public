...
function nm() {
    ...
    var S = Symbol.for("react.transitional.element")
      ...
      , vl = Symbol.iterator;
    function Ml(v) {
        return v === null || typeof v != "object" ? null : (v = vl && v[vl] || v["@@iterator"],
    ...
    Yl.prototype.setState = function(v, T) {
        if (typeof v != "object" && typeof v != "function" && v != null)
            throw Error("takes an object of state variables to update or a function which returns an object of state variables.");
        this.updater.enqueueSetState(this, v, T, "setState")
    }
    ,
    Yl.prototype.forceUpdate = function(v) {
        this.updater.enqueueForceUpdate(this, v, "forceUpdate")
    }
    ;
    function Tt() {}
    Tt.prototype = Yl.prototype;
    function jl(v, T, _) {
        this.props = v,
        this.context = T,
        this.refs = Et,
    ...
    var Eu = /\/+/g;
    function Nt(v, T) {
        return typeof v == "object" && v !== null && v.key != null ? Zl("" + v.key) : T.toString(36)
    }
    function gt(v) {
        switch (v.status) {
        case "fulfilled":
        ...
        case "rejected":
            throw v.reason;
        default:
            switch (typeof v.status == "string" ? v.then(Xl, Xl) : (v.status = "pending",
            v.then(function(T) {
    ...
    function b(v, T, _, N, G) {
        ...
        if (ll)
            ...
            ll = N === "" ? "." + Nt(v, 0) : N,
            At(G) ? (_ = "",
            ll != null && (_ = ll.replace(Eu, "$&/") + "/"),
            b(G, T, _, "", function(Ma) {
                return Ma
            })) : G != null && (_t(G) && (G = Qu(G, _ + (G.key == null || v && v.key === G.key ? "" : ("" + G.key).replace(Eu, "$&/") + "/") + ll)),
            T.push(G)),
            1;
        ll = 0;
        var Bl = N === "" ? "." : N + ":";
    ...
    B.cloneElement = function(v, T, _) {
        ...
        var N = Ul({}, v.props)
          , G = v.key;
        if (T != null)
            for (V in T.key !== void 0 && (G = "" + T.key),
            T)
                !Ql.call(T, V) || V === "key" || V === "__self" || V === "__source" || V === "ref" && T.ref === void 0 || (N[V] = T[V]);
        var V = arguments.length - 2;
        if (V === 1)
            N.children = _;
        else if (1 < V) {
            for (var ll = Array(V), Bl = 0; Bl < V; Bl++)
                ll[Bl] = arguments[Bl + 2];
            N.children = ll
        }
        return Ot(v.type, G, N)
    }
    ,
    ...
    B.createElement = function(v, T, _) {
        var N, G = {}, V = null;
        if (T != null)
            for (N in T.key !== void 0 && (V = "" + T.key),
            T)
                Ql.call(T, N) && N !== "key" && N !== "__self" && N !== "__source" && (G[N] = T[N]);
    ...
    B.startTransition = function(v) {
        ...
        try {
            var N = v()
              , G = W.S;
            G !== null && G(_, N),
            typeof N == "object" && N !== null && typeof N.then == "function" && N.then(Xl, al)
        } catch (V) {
            al(V)
        } finally {
    ...
    B.useActionState = function(v, T, _) {
        return W.H.useActionState(v, T, _)
    }
    ,
    ...
    B.useImperativeHandle = function(v, T, _) {
        return W.H.useImperativeHandle(v, T, _)
    }
    ,
    ...
    B.useSyncExternalStore = function(v, T, _) {
        return W.H.useSyncExternalStore(v, T, _)
    }
    ,
...
function fm() {
    ...
    (function(S) {
        ...
        function C(b, O) {
            var x = b.sortIndex - O.sortIndex;
            return x !== 0 ? x : b.id - O.id
        }
        ...
        var Xl = !1
          ...
          , Ot = -1;
        function Qu() {
            return Et ? !0 : !(S.unstable_now() - Ot < Ql)
        }
        function _t() {
            if (Et = !1,
            Xl) {
                ...
                try {
                    l: {
                        ...
                        try {
                            t: {
                                for (ft(b),
                                j = M(p); j !== null && !(j.expirationTime > b && Qu()); ) {
                                    var al = j.callback;
                                    if (typeof al == "function") {
                                        j.callback = null,
                                        vl = j.priorityLevel;
                                        var cl = al(j.expirationTime <= b);
                                        if (b = S.unstable_now(),
                                        typeof cl == "function") {
                                            j.callback = cl,
                                            ft(b),
        ...
        S.unstable_forceFrameRate = function(b) {
            0 > b || 125 < b ? console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported") : Ql = 0 < b ? Math.floor(1e3 / b) : 5
        }
        ,
        ...
        ,
        S.unstable_runWithPriority = function(b, O) {
            switch (b) {
            case 1:
            case 2:
            case 3:
        ...
        ,
        S.unstable_scheduleCallback = function(b, O, x) {
            var al = S.unstable_now();
            switch (typeof x == "object" && x !== null ? (x = x.delay,
            x = typeof x == "number" && 0 < x ? al + x : al) : x = al,
            b) {
            case 1:
                var cl = -1;
                break;
            ...
            x > al ? (b.sortIndex = x,
            U(A, b),
            M(p) === null && b === M(A) && (Ul ? (Tt(W),
            W = -1) : Ul = !0,
            gt(At, x - al))) : (b.sortIndex = cl,
            U(p, b),
            dl || Ml || (dl = !0,
            Xl || (Xl = !0,
            Zl()))),
...
function im() {
    ...
    var sl = S.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
    function hl(p, A) {
        if (p === "font")
            return "";
        if (typeof A == "string")
    ...
    return xl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = o,
    xl.createPortal = function(p, A) {
    ...
    ,
    xl.preconnect = function(p, A) {
        typeof p == "string" && (A ? (A = A.crossOrigin,
        A = typeof A == "string" ? A === "use-credentials" ? A : "" : void 0) : A = null,
        o.d.C(p, A))
    }
    ,
    xl.prefetchDNS = function(p) {
        typeof p == "string" && o.d.D(p)
    }
    ,
    xl.preinit = function(p, A) {
        if (typeof p == "string" && A && typeof A.as == "string") {
            var F = A.as
              , j = hl(F, A.crossOrigin)
              , vl = typeof A.integrity == "string" ? A.integrity : void 0
              , Ml = typeof A.fetchPriority == "string" ? A.fetchPriority : void 0;
            F === "style" ? o.d.S(p, typeof A.precedence == "string" ? A.precedence : void 0, {
                crossOrigin: j,
                integrity: vl,
                fetchPriority: Ml
            }) : F === "script" && o.d.X(p, {
    ...
    ,
    xl.preinitModule = function(p, A) {
        if (typeof p == "string")
            if (typeof A == "object" && A !== null) {
                if (A.as == null || A.as === "script") {
                    var F = hl(A.as, A.crossOrigin);
                    o.d.M(p, {
                        crossOrigin: F,
    ...
    ,
    xl.requestFormReset = function(p) {
        o.d.r(p)
    }
    ,
    xl.unstable_batchedUpdates = function(p, A) {
        return p(A)
    }
    ,
    xl.useFormState = function(p, A, F) {
        return sl.H.useFormState(p, A, F)
    }
    ,
...
function vm() {
    ...
    function Bl(l, t) {
        ...
        case 9:
        case 11:
            l = (l = t.documentElement) && (l = l.namespaceURI) ? G1(l) : 0;
            break;
        default:
            if (l = t.tagName,
            t = t.namespaceURI)
...
` + a.stack
    ...
    var Jn = Object.prototype.hasOwnProperty
      , wn = S.unstable_scheduleCallback
      , Wn = S.unstable_cancelCallback
      , qv = S.unstable_shouldYield
      , jv = S.unstable_requestPaint
      , Fl = S.unstable_now
      , xv = S.unstable_getCurrentPriorityLevel
      , gi = S.unstable_ImmediatePriority
      , Si = S.unstable_UserBlockingPriority
      , Ae = S.unstable_NormalPriority
      , Yv = S.unstable_LowPriority
      , bi = S.unstable_IdlePriority
      , Bv = S.log
      , Gv = S.unstable_setDisableYieldValue
      , pa = null
      , kl = null;
    function $t(l) {
        if (typeof Bv == "function" && Gv(l),
        kl && typeof kl.setStrictMode == "function")
            try {
                kl.setStrictMode(pa, l)
            } catch {}
    }
    var Il = Math.clz32 ? Math.clz32 : Zv
      , Xv = Math.log
      , Qv = Math.LN2;
    function Zv(l) {
        return l >>>= 0,
        l === 0 ? 32 : 31 - (Xv(l) / Qv | 0) | 0
    }
    var Oe = 256
      , _e = 262144
      , Me = 4194304;
    ...
    var wv = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$")
      ...
      , Ni = {};
    function Wv(l) {
        return Jn.call(Ni, l) ? !0 : Jn.call(Ui, l) ? !1 : wv.test(l) ? Ni[l] = !0 : (Ui[l] = !0,
        !1)
    }
    function De(l, t, u) {
        if (Wv(t))
    ...
    function tf(l, t, u, a, e, n, f, c) {
        ...
        t != null ? f === "number" ? (t === 0 && l.value === "" || l.value != t) && (l.value = "" + ct(t)) : l.value !== "" + ct(t) && (l.value = "" + ct(t)) : f !== "submit" && f !== "reset" || l.removeAttribute("value"),
        t != null ? uf(l, f, ct(t)) : u != null ? uf(l, f, ct(u)) : a != null && l.removeAttribute("value"),
        e == null && n != null && (l.defaultChecked = !!n),
        e != null && (l.checked = e && typeof e != "function" && typeof e != "symbol"),
        c != null && typeof c != "function" && typeof c != "symbol" && typeof c != "boolean" ? l.name = "" + ct(c) : l.removeAttribute("name")
    }
    ...
    var kv = new Set("animationIterationCount aspectRatio borderImageOutset borderImageSlice borderImageWidth boxFlex boxFlexGroup boxOrdinalGroup columnCount columns flex flexGrow flexPositive flexShrink flexNegative flexOrder gridArea gridRow gridRowEnd gridRowSpan gridRowStart gridColumn gridColumnEnd gridColumnSpan gridColumnStart fontWeight lineClamp lineHeight opacity order orphans scale tabSize widows zIndex zoom fillOpacity floodOpacity stopOpacity strokeDasharray strokeDashoffset strokeMiterlimit strokeOpacity strokeWidth MozAnimationIterationCount MozBoxFlex MozBoxFlexGroup MozLineClamp msAnimationIterationCount msFlex msZoom msFlexGrow msFlexNegative msFlexOrder msFlexPositive msFlexShrink msGridColumn msGridColumnSpan msGridRow msGridRowSpan WebkitAnimationIterationCount WebkitBoxFlex WebKitBoxFlexGroup WebkitBoxOrdinalGroup WebkitColumnCount WebkitColumns WebkitFlex WebkitFlexGrow WebkitFlexPositive WebkitFlexShrink WebkitLineClamp".split(" "));
    function xi(l, t, u) {
        var a = t.indexOf("--") === 0;
        u == null || typeof u == "boolean" || u === "" ? a ? l.setProperty(t, "") : t === "float" ? l.cssFloat = "" : l[t] = "" : a ? l.setProperty(t, u) : typeof u != "number" || u === 0 || kv.has(t) ? t === "float" ? l.cssFloat = u : l[t] = ("" + u).trim() : l[t] = u + "px"
    }
    function Yi(l, t, u) {
        ...
        u != null) {
            ...
            for (var e in t)
                a = t[e],
                t.hasOwnProperty(e) && u[e] !== a && xi(l, e, a)
        } else
            for (var n in t)
    ...
    function Bi(l) {
        ...
        if (t && (l = t.stateNode)) {
            ...
            t.type) {
            case "input":
                if (tf(l, u.value, u.defaultValue, u.defaultValue, u.checked, u.defaultChecked, u.type, u.name),
                t = u.name,
                u.type === "radio" && t != null) {
                    for (u = l; u.parentNode; )
                        u = u.parentNode;
                    for (u = u.querySelectorAll('input[name="' + it("" + t) + '"][type="radio"]'),
                    t = 0; t < u.length; t++) {
                        var a = u[t];
                        if (a !== l && a.form === l.form) {
                            ...
                            if (!e)
                                throw Error(o(90));
                            tf(a, e.value, e.defaultValue, e.defaultValue, e.checked, e.defaultChecked, e.type, e.name)
                        }
                    }
    ...
    function Xi() {
        if (Re)
            return Re;
        var l, t = sf, u = t.length, a, e = "value"in kt ? kt.value : kt.textContent, n = e.length;
    ...
    function Ll(l) {
        function t(u, a, e, n, f) {
            ...
            for (var c in l)
                ...
                this[c] = u ? u(n) : n[c]);
            return this.isDefaultPrevented = (n.defaultPrevented != null ? n.defaultPrevented : n.returnValue === !1) ? qe : Qi,
    ...
    var _u = {
        ...
        movementX: function(l) {
            return "movementX"in l ? l.movementX : (l !== ja && (ja && l.type === "mousemove" ? (vf = l.screenX - ja.screenX,
            of = l.screenY - ja.screenY) : of = vf = 0,
            ja = l),
            vf)
        },
    ...
    function yo(l) {
        ...
        return t.getModifierState ? t.getModifierState(l) : (l = oo[l]) ? !!t[l] : !1
    }
    function mf() {
        return yo
    }
    var mo = j({}, qa, {
        key: function(l) {
            ...
            return l.type === "keypress" ? (l = Ce(l),
            l === 13 ? "Enter" : String.fromCharCode(l)) : l.type === "keydown" || l.type === "keyup" ? vo[l.keyCode] || "Unidentified" : ""
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
    ...
    var Mo = Ct && "TextEvent"in window && !xa
      , Ki = Ct && (!df || xa && 8 < xa && 11 >= xa)
      , Ji = " "
      , wi = !1;
    function Wi(l, t) {
        switch (l) {
    ...
    function Do(l, t) {
        if (ku)
            return l === "compositionend" || !df && Wi(l, t) ? (l = Xi(),
            Re = sf = kt = null,
            ku = !1,
            l) : null;
        switch (l) {
    ...
    function ki(l, t, u, a) {
        ...
        t = Mn(t, "onChange"),
        0 < t.length && (u = new je("onChange","change",null,u,a),
        l.push({
            event: u,
            listeners: t
        }))
    ...
    if (Ct) {
        ...
        if (Ct) {
            ...
            if (!rf) {
                ...
                rf = typeof l0.oninput == "function"
            }
            hf = rf
        } else
            hf = !1;
        Pi = hf && (!document.documentMode || 9 < document.documentMode)
    }
    function t0() {
        Ya && (Ya.detachEvent("onpropertychange", u0),
        Ba = Ya = null)
    }
    function u0(l) {
    ...
    function Ho(l, t, u) {
        ...
        Ya = t,
        Ba = u,
        Ya.attachEvent("onpropertychange", u0)) : l === "focusout" && t0()
    }
    function Ro(l) {
    ...
    var Pl = typeof Object.is == "function" ? Object.is : jo;
    function Ga(l, t) {
        if (Pl(l, t))
            return !0;
    ...
    var xo = Ct && "documentMode"in document && 11 >= document.documentMode
      , Iu = null
      , Sf = null
      , Xa = null
      , bf = !1;
    function c0(l, t, u) {
        ...
        bf || Iu == null || Iu !== Ne(a) || (a = Iu,
        "selectionStart"in a && gf(a) ? a = {
        ...
        Xa && Ga(Xa, a) || (Xa = a,
        a = Mn(Sf, "onSelect"),
        0 < a.length && (t = new je("onSelect","select",null,t,u),
        l.push({
            event: t,
            listeners: a
        }),
    ...
    var Pu = {
      ...
      , zf = {}
      , i0 = {};
    Ct && (i0 = document.createElement("div").style,
    "AnimationEvent"in window || (delete Pu.animationend.animation,
    ...
    function pu(l) {
        ...
        var t = Pu[l], u;
        for (u in t)
            if (t.hasOwnProperty(u) && u in i0)
                return zf[l] = t[u];
        return l
    }
    var s0 = pu("animationend")
      , v0 = pu("animationiteration")
      , o0 = pu("animationstart")
      , Yo = pu("transitionrun")
      , Bo = pu("transitionstart")
      , Go = pu("transitioncancel")
      , y0 = pu("transitionend")
      , m0 = new Map
    ...
    function qt(l, t) {
        var u = l.alternate;
        return u === null ? (u = lt(l.tag, t, l.key, l.mode),
    ...
    function Ze(l, t, u, a, e, n) {
        ...
        typeof l == "function")
            ...
            f = Ky(l, u, N.current) ? 26 : l === "html" || l === "head" || l === "body" ? 27 : 5;
        else
            l: switch (l) {
            case Ot:
                return l = lt(31, u, t, e),
                l.elementType = Ot,
                l.lanes = n,
                l;
            case Ul:
            ...
            case Et:
                ...
                break;
            case Yl:
                return l = lt(12, u, t, e | 2),
                l.elementType = Yl,
                l.lanes = n,
                l;
            case At:
                return l = lt(13, u, t, e),
                l.elementType = At,
                l.lanes = n,
                l;
            case Xl:
                return l = lt(19, u, t, e),
                l.elementType = Xl,
                l.lanes = n,
                l;
            default:
    ...
    function z0(l) {
        ...
        case "input":
            K("invalid", t),
            Ci(t, a.value, a.defaultValue, a.checked, a.defaultChecked, a.type, a.name, !0);
            break;
        case "select":
            K("invalid", t);
            break;
        case "textarea":
            K("invalid", t),
            ji(t, a.value, a.defaultValue, a.children)
        }
        u = a.children,
        typeof u != "string" && typeof u != "number" && typeof u != "bigint" || t.textContent === "" + u || a.suppressHydrationWarning === !0 || Y1(t.textContent, u) ? (a.popover != null && (K("beforetoggle", t),
        K("toggle", t)),
    ...
    function ea(l) {
        ...
        t === 13) {
            ...
            du(l.type) ? (l = Ic,
            Ic = null,
            ol = l) : ol = t) : ol = Hl ? ht(l.stateNode.nextSibling) : null;
        return !0
    }
    function Nu() {
        ol = Hl = null,
    ...
    var Hf = v(null)
      ...
      , xt = null;
    function tu(l, t, u) {
        _(Hf, t._currentValue),
        t._currentValue = u
    }
    function Yt(l) {
        l._currentValue = Hf.current,
        T(Hf)
    }
    function Rf(l, t, u) {
        for (; l !== null; ) {
    ...
    var Qo = typeof AbortController < "u" ? AbortController : function() {
      ...
      , Zo = S.unstable_scheduleCallback
      , Vo = S.unstable_NormalPriority
      , El = {
        $$typeof: jl,
        Consumer: null,
        Provider: null,
    ...
    b.S = function(l, t) {
        c1 = Fl(),
        typeof t == "object" && t !== null && typeof t.then == "function" && Lo(l, t),
        O0 !== null && O0(l, t)
    }
    ;
    var Cu = v(null);
    ...
    function p0(l, t, u) {
        switch (u = l[u],
        u === void 0 ? l.push(t) : u !== t && (t.then(Rt, Rt),
        t = u),
        t.status) {
        case "fulfilled":
            return t.value;
    ...
    function qu(l) {
        try {
            ...
            throw u !== null && typeof u == "object" && typeof u.then == "function" ? (ju = u,
            ia) : u
        }
    }
    var ju = null;
    ...
    function Fe(l, t) {
        throw t.$$typeof === vl ? Error(o(525)) : (l = Object.prototype.toString.call(t),
    ...
    function N0(l) {
        ...
        function a(y) {
            for (var s = new Map; y !== null; )
                y.key !== null ? s.set(y.key, y) : s.set(y.index, y),
                y = y.sibling;
            return s
        }
        function e(y, s) {
        ...
        function n(y, s, m) {
            ...
            l ? (m = y.alternate,
            m !== null ? (m = m.index,
            m < s ? (y.flags |= 67108866,
            s) : m) : (y.flags |= 67108866,
            s)) : (y.flags |= 1048576,
            s)
        }
        function f(y) {
        ...
        function c(y, s, m, z) {
            return s === null || s.tag !== 6 ? (s = _f(m, y.mode, z),
            s.return = y,
            s) : (s = e(s, m),
            s.return = y,
            s)
        ...
        function i(y, s, m, z) {
            var R = m.type;
            return R === Ul ? g(y, s, m.props.children, z, m.key) : s !== null && (s.elementType === R || typeof R == "object" && R !== null && R.$$typeof === Ql && qu(R) === s.type) ? (s = e(s, m.props),
            Ja(s, m),
            s.return = y,
            s) : (s = Ze(m.type, m.key, m.props, null, y.mode, z),
            Ja(s, m),
            s.return = y,
            s)
        }
        function d(y, s, m, z) {
            return s === null || s.tag !== 4 || s.stateNode.containerInfo !== m.containerInfo || s.stateNode.implementation !== m.implementation ? (s = Mf(m, y.mode, z),
            s.return = y,
            s) : (s = e(s, m.children || []),
            s.return = y,
            s)
        }
        function g(y, s, m, z, R) {
            return s === null || s.tag !== 7 ? (s = Uu(m, y.mode, z, R),
            s.return = y,
            s) : (s = e(s, m),
            s.return = y,
            s)
        ...
        function E(y, s, m) {
            if (typeof s == "string" && s !== "" || typeof s == "number" || typeof s == "bigint")
                return s = _f("" + s, y.mode, m),
                s.return = y,
                s;
            if (typeof s == "object" && s !== null) {
                switch (s.$$typeof) {
                case Ml:
                    return m = Ze(s.type, s.key, s.props, null, y.mode, m),
                    Ja(m, s),
                    m.return = y,
                    m;
                case dl:
                    return s = Mf(s, y.mode, m),
                    s.return = y,
                    s;
                case Ql:
                    return s = qu(s),
        ...
        function h(y, s, m, z) {
            ...
            if (typeof m == "string" && m !== "" || typeof m == "number" || typeof m == "bigint")
                return R !== null ? null : c(y, s, "" + m, z);
            if (typeof m == "object" && m !== null) {
                switch (m.$$typeof) {
                case Ml:
                    return m.key === R ? i(y, s, m, z) : null;
                case dl:
                    return m.key === R ? d(y, s, m, z) : null;
                case Ql:
                    return m = qu(m),
                    h(y, s, m, z)
                }
                if (gt(m) || Zl(m))
                    return R !== null ? null : g(y, s, m, z, null);
                if (typeof m.then == "function")
                    return h(y, s, $e(m), z);
                if (m.$$typeof === jl)
                    return h(y, s, Ke(y, m), z);
                Fe(y, m)
            }
            return null
        }
        function r(y, s, m, z, R) {
            ...
            if (typeof z == "object" && z !== null) {
                switch (z.$$typeof) {
                case Ml:
                    return y = y.get(z.key === null ? m : z.key) || null,
                    i(s, y, z, R);
                case dl:
                    return y = y.get(z.key === null ? m : z.key) || null,
                    d(s, y, z, R);
                ...
                if (typeof z.then == "function")
                    return r(y, s, m, $e(z), R);
                if (z.$$typeof === jl)
                    return r(y, s, m, Ke(s, z), R);
                Fe(s, z)
            }
            return null
        }
        function D(y, s, m, z) {
            for (var R = null, k = null, H = s, Z = s = 0, w = null; H !== null && Z < m.length; Z++) {
                H.index > Z ? (w = H,
                H = null) : w = H.sibling;
                var I = h(y, H, m[Z], z);
                if (I === null) {
            ...
            for (H = a(H); Z < m.length; Z++)
                w = r(H, y, Z, m[Z], z),
                w !== null && (l && w.alternate !== null && H.delete(w.key === null ? Z : w.key),
                s = n(w, s, Z),
        ...
        function q(y, s, m, z) {
            if (m == null)
                throw Error(o(151));
            for (var R = null, k = null, H = s, Z = s = 0, w = null, I = m.next(); H !== null && !I.done; Z++,
            I = m.next()) {
                H.index > Z ? (w = H,
                H = null) : w = H.sibling;
                var bu = h(y, H, I.value, z);
                if (bu === null) {
                    H === null && (H = w);
                    break
                }
            ...
            I = m.next())
                I = r(H, y, Z, I.value, z),
                I !== null && (l && I.alternate !== null && H.delete(I.key === null ? Z : I.key),
                s = n(I, s, Z),
                k === null ? R = I : k.sibling = I,
                k = I);
        ...
        function fl(y, s, m, z) {
            if (typeof m == "object" && m !== null && m.type === Ul && m.key === null && (m = m.props.children),
                    ...
                    l: {
                        for (var R = m.key; s !== null; ) {
                            if (s.key === R) {
                                ...
                                } else if (s.elementType === R || typeof R == "object" && R !== null && R.$$typeof === Ql && qu(R) === s.type) {
                                    u(y, s.sibling),
                                    z = e(s, m.props),
                                    Ja(z, m),
                                    z.return = y,
                        ...
                        m.type === Ul ? (z = Uu(m.props.children, y.mode, z, m.key),
                        z.return = y,
                        y = z) : (z = Ze(m.type, m.key, m.props, null, y.mode, z),
                        Ja(z, m),
                        z.return = y,
                        y = z)
                    }
            ...
            do {
                ...
                if (r ? (J & h) === h : (a & h) === h) {
                    ...
                    l: {
                        ...
                        case 0:
                            if (D = q.payload,
                            h = typeof D == "function" ? D.call(fl, E, h) : D,
                            h == null)
                                break l;
                            E = j({}, E, h);
                            break l;
    ...
    function Jf(l, t, u, a, e, n) {
        ...
        t.updateQueue = null,
        t.lanes = 0,
        b.H = l === null || l.memoizedState === null ? Ss : cc,
        Yu = !1,
        n = u(a, e),
        Yu = !1,
        oa && (n = Y0(t, u, a, e)),
    ...
    function Gl() {
        ...
        return Tl === null ? X.memoizedState = Tl = l : Tl = Tl.next = l,
        Tl
    }
    function zl() {
        if (el === null) {
    ...
    function ka(l) {
        ...
        l = p0(ya, l, t),
        t = X,
        (Tl === null ? t.memoizedState : Tl.next) === null && (t = t.alternate,
        b.H = t === null || t.memoizedState === null ? Ss : cc),
        l
    }
    function un(l) {
    ...
    function B0(l, t, u) {
        ...
        Al = !0),
        e = e.queue,
        tc(Q0.bind(null, a, e, l), [l]),
        e.getSnapshot !== t || f || Tl !== null && Tl.memoizedState.tag & 1) {
            if (a.flags |= 2048,
            ma(9, {
                destroy: void 0
            }, X0.bind(null, a, e, u, t), null),
            il === null)
                throw Error(o(349));
            n || (Bt & 127) !== 0 || G0(a, t, u)
        }
    ...
    function L0(l, t, u, a) {
        ...
        kf(l, el, typeof a == "function" ? a : Gt)
    }
    ...
    function I0(l, t, u) {
        ...
        var e = t.queue
          , n = e.dispatch;
        return u !== t.memoizedState && (X.flags |= 2048,
        ma(9, {
            destroy: void 0
        }, $o.bind(null, e, u), null)),
        [a, n, l]
    }
    function $o(l, t) {
        l.action = t
    ...
    function nn(l, t, u, a) {
        ...
        el !== null && a !== null && Kf(a, el.memoizedState.deps) ? e.memoizedState = ma(t, n, u, a) : (X.flags |= l,
    ...
    function cs(l, t) {
        ...
        return t !== null && Kf(t, a[1]) ? a[0] : (u.memoizedState = [l, t],
        l)
    }
    function is(l, t) {
        var u = zl();
    ...
    function ac(l, t, u) {
        return u === void 0 || (Bt & 1073741824) !== 0 && (J & 261930) === 0 ? l.memoizedState = t : (l.memoizedState = u,
        l = s1(),
        X.lanes |= l,
        su |= l,
        u)
    ...
    function ss(l, t, u, a) {
        return Pl(u, t) ? u : va.current !== null ? (l = ac(l, u, a),
        Pl(l, t) || (Al = !0),
        l) : (Bt & 42) === 0 || (Bt & 1073741824) !== 0 && (J & 261930) === 0 ? (Al = !0,
        l.memoizedState = u) : (l = s1(),
        X.lanes |= l,
        su |= l,
        t)
    }
    ...
    var Ss = {
        ...
        useCallback: function(l, t) {
            return Gl().memoizedState = [l, t === void 0 ? null : t],
            l
        },
        useContext: Rl,
        useEffect: ts,
        ...
        useTransition: function() {
            var l = Pf(!1);
            return l = vs.bind(null, X, l.queue, !0, !1),
            Gl().memoizedState = l,
            [!1, l]
        },
        ...
        useOptimistic: function(l) {
            ...
            return t.queue = u,
            t = fc.bind(null, X, !0, u),
            u.dispatch = t,
            [l, t]
        },
        useMemoCache: Ff,
        useCacheRefresh: function() {
            return Gl().memoizedState = Io.bind(null, X)
        },
      ...
      , cc = {
        ...
        useDeferredValue: function(l, t) {
            var u = zl();
            return ss(u, el.memoizedState, l, t)
        },
        useTransition: function() {
            var l = an(Gt)[0]
              , t = zl().memoizedState;
    ...
    var bs = {
        ...
        useDeferredValue: function(l, t) {
            var u = zl();
            return el === null ? ac(u, l, t) : ss(u, el.memoizedState, l, t)
        },
        useTransition: function() {
            var l = If(Gt)[0]
              , t = zl().memoizedState;
        ...
        useOptimistic: function(l, t) {
            var u = zl();
            return el !== null ? L0(u, el, l, t) : (u.baseState = l,
            [l, u.queue.dispatch])
        },
        useMemoCache: Ff,
        useCacheRefresh: ds
    ...
    function ly(l, t, u, a, e) {
        ...
        a !== null && typeof a == "object" && typeof a.then == "function") {
            ...
            u !== null) {
                ...
                case 31:
                case 13:
                    return dt === null ? zn() : u.alternate === null && gl === 0 && (gl = 3),
                    u.flags &= -257,
                    u.flags |= 65536,
                    u.lanes = e,
                    a === We ? u.flags |= 16384 : (t = u.updateQueue,
        ...
        do {
            ...
            case 3:
                ...
                l = e & -e,
                u.lanes |= l,
                l = vc(u.stateNode, a, l),
                Xf(u, l),
                !1;
            case 1:
                if (t = u.type,
                n = u.stateNode,
                (u.flags & 128) === 0 && (typeof t.getDerivedStateFromError == "function" || n !== null && typeof n.componentDidCatch == "function" && (vu === null || !vu.has(n))))
                    return u.flags |= 65536,
                    e &= -e,
                    u.lanes |= e,
                    e = Ms(e),
    ...
    var oc = Error(o(461))
      , Al = !1;
    function Cl(l, t, u, a) {
        t.child = l === null ? H0(t, null, u, a) : xu(t, l.child, u, a)
    }
    ...
    function Us(l, t, u, a, e) {
        if (l === null) {
            var n = u.type;
            return typeof n == "function" && !Of(n) && n.defaultProps === void 0 && u.compare === null ? (t.tag = 15,
            t.type = n,
            Ns(l, t, n, a, e)) : (l = Ze(u.type, null, a, t, t.mode, e),
            l.ref = t.ref,
            l.return = t,
            t.child = l)
        }
    ...
    function js(l, t, u, a, e) {
        ...
        t.stateNode === null) {
            ...
            var d = n.context
              , g = u.contextType;
            f = ta,
            typeof g == "object" && g !== null && (f = Rl(g));
            var E = u.getDerivedStateFromProps;
            g = typeof E == "function" || typeof n.getSnapshotBeforeUpdate == "function",
            c = t.pendingProps !== c,
            g || typeof n.UNSAFE_componentWillReceiveProps != "function" && typeof n.componentWillReceiveProps != "function" || (c || d !== f) && Es(t, n, a, f),
            uu = !1;
            ...
            Wa(),
            d = t.memoizedState,
            c || h !== d || uu ? (typeof E == "function" && (ic(t, u, E, a),
            d = t.memoizedState),
            (i = uu || zs(t, u, i, a, h, d, f)) ? (g || typeof n.UNSAFE_componentWillMount != "function" && typeof n.componentWillMount != "function" || (typeof n.componentWillMount == "function" && n.componentWillMount(),
            typeof n.UNSAFE_componentWillMount == "function" && n.UNSAFE_componentWillMount()),
            ...
            (d = typeof c == "function" || typeof n.getSnapshotBeforeUpdate == "function") || typeof n.UNSAFE_componentWillReceiveProps != "function" && typeof n.componentWillReceiveProps != "function" || (f !== E || h !== i) && Es(t, n, a, i),
            uu = !1,
            h = t.memoizedState,
            n.state = h,
            $a(t, a, n, e),
            ...
            f !== E || h !== r || uu || l !== null && l.dependencies !== null && Le(l.dependencies) ? (typeof c == "function" && (ic(t, u, c, a),
            r = t.memoizedState),
            (g = uu || zs(t, u, g, a, h, r, i) || l !== null && l.dependencies !== null && Le(l.dependencies)) ? (d || typeof n.UNSAFE_componentWillUpdate != "function" && typeof n.componentWillUpdate != "function" || (typeof n.componentWillUpdate == "function" && n.componentWillUpdate(a, r, i),
        ...
        t.flags |= 1,
        l !== null && a ? (t.child = xu(t, l.child, null, e),
        t.child = xu(t, null, u, e)) : Cl(l, t, u, e),
    ...
    function Ys(l, t, u) {
        ...
        l === null) {
            if ($) {
                ...
                l === null)
                    throw lu(t);
                return kc(l) ? t.lanes = 32 : t.lanes = 536870912,
                null
            }
            var c = a.children;
            return a = a.fallback,
        ...
        c !== null)) {
            if (n)
                t.flags & 256 ? (nu(t),
                t.flags &= -257,
                t = gc(l, t, u)) : t.memoizedState !== null ? (fu(),
                t.child = l.child,
                t.flags |= 128,
                t = null) : (fu(),
                c = a.fallback,
        ...
        d !== null ? c = qt(d, c) : (c = Uu(c, e, u, null),
        c.flags |= 2),
        c.return = t,
        a.return = t,
        a.sibling = c,
        ...
        c === null ? c = dc(u) : (e = c.cachePool,
        e !== null ? (i = El._currentValue,
        e = e.parent !== i ? {
            parent: i,
            pool: i
        } : e) : e = _0(),
    ...
    function uy(l, t, u) {
        ...
        case 13:
            ...
            if (a !== null)
                return a.dehydrated !== null ? (nu(t),
                t.flags |= 128,
                null) : (u & t.child.childLanes) !== 0 ? Ys(l, t, u) : (nu(t),
                l = Xt(l, t, u),
    ...
    function Xs(l, t, u) {
        if (l !== null)
            ...
            Al = !1,
            $ && (t.flags & 1048576) !== 0 && S0(t, Qa, t.index);
        switch (t.lanes = 0,
        t.tag) {
        case 16:
            l: {
                var a = t.pendingProps;
                if (l = qu(t.elementType),
                t.type = l,
                typeof l == "function")
                    Of(l) ? (a = Bu(l, a),
                    t.tag = 1,
                    t = js(null, t, l, a, u)) : (t.tag = 0,
                    t = yc(null, t, l, a, u));
                else {
                    if (l != null) {
                        var e = l.$$typeof;
        ...
        case 3:
            l: {
                if (Bl(t, t.stateNode.containerInfo),
                l === null)
                    throw Error(o(387));
                a = t.pendingProps;
        ...
        case 26:
            return vn(l, t),
            l === null ? (u = k1(t.type, null, t.pendingProps, null)) ? t.memoizedState = u : $ || (u = t.type,
            l = t.pendingProps,
            ...
            ql(a, u, l),
            pl(a),
            t.stateNode = a) : t.memoizedState = k1(t.type, l.memoizedProps, t.pendingProps, l.memoizedState),
            null;
        case 27:
            return Ma(t),
            l === null && $ && (a = t.stateNode = W1(t.type, t.pendingProps, V.current),
            Hl = t,
            mt = !0,
            e = ol,
            du(t.type) ? (Ic = e,
            ol = ht(a.firstChild)) : ol = e),
            Cl(l, t, t.pendingProps.children, u),
            vn(l, t),
            l === null && (t.flags |= 4194304),
            t.child;
        case 5:
            return l === null && $ && ((e = a = ol) && (a = Ry(a, t.type, t.pendingProps, mt),
            ...
            a = n.children,
            wc(e, n) ? a = null : f !== null && wc(e, f) && (t.flags |= 32),
            t.memoizedState !== null && (e = Jf(l, t, wo, null, null, u),
            he._currentValue = e),
            vn(l, t),
            Cl(l, t, a, u),
            t.child;
        case 6:
            return l === null && $ && ((l = u = ol) && (u = Cy(u, t.pendingProps, mt),
        ...
        case 4:
            ...
            a = t.pendingProps,
            l === null ? t.child = xu(t, null, a, u) : Cl(l, t, a, u),
            t.child;
        case 11:
            return Ds(l, t, t.type, t.pendingProps, u);
        case 7:
            return Cl(l, t, t.pendingProps, u),
            t.child;
        case 8:
            return Cl(l, t, t.pendingProps.children, u),
            t.child;
        case 12:
            return Cl(l, t, t.pendingProps.children, u),
            t.child;
    ...
    function yn(l, t) {
        t !== null && (l.flags |= 4),
        l.flags & 16384 && (t = l.tag !== 22 ? zi() : 536870912,
        l.lanes |= t,
        ga |= t)
    }
    function te(l, t) {
    ...
    function ay(l, t, u) {
        ...
        case 3:
            ...
            (l === null || l.child === null) && (ea(t) ? Qt(t) : l === null || l.memoizedState.isDehydrated && (t.flags & 256) === 0 || (t.flags |= 1024,
            Nf())),
            yl(t),
            null;
        case 26:
            ...
            n !== null ? (yl(t),
            Qs(t, n)) : (yl(t),
            zc(t, e, null, a, u))) : n ? n !== l.memoizedState ? (Qt(t),
            yl(t),
            Qs(t, n)) : (yl(t),
        ...
        case 6:
            if (l && t.stateNode != null)
                ...
                ea(t)) {
                    ...
                    l[Nl] = t,
                    l = !!(l.nodeValue === u || a !== null && a.suppressHydrationWarning === !0 || Y1(l.nodeValue, u)),
                    l || lu(t, !0)
                } else
                    l = pn(l).createTextNode(a),
                    l[Nl] = t,
                    t.stateNode = l
            }
            return yl(t),
        ...
        case 4:
            return Sl(),
            l === null && Zc(t.stateNode.containerInfo),
            yl(t),
            null;
        case 10:
            return Yt(t.type),
            ...
            n === null)
                        ...
                        for (l = t.child; l !== null; ) {
                            ...
                            n !== null) {
                                ...
                                u = t.child; u !== null; )
                                    h0(u, l),
                                    u = u.sibling;
                                return _(bl, bl.current & 1 | 2),
                                $ && jt(t, a.treeForkCount),
                                t.child
                            }
                            l = l.sibling
                        }
                    a.tail !== null && Fl() > gn && (t.flags |= 128,
                    e = !0,
                    te(a, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!e)
                    ...
                    l !== null) {
                        ...
                        yn(t, l),
                        te(a, !0),
                        a.tail === null && a.tailMode === "hidden" && !n.alternate && !$)
                            return yl(t),
                            null
                    } else
                        2 * Fl() - a.renderingStartTime > gn && u !== 536870912 && (t.flags |= 128,
                        e = !0,
                        te(a, !1),
                        t.lanes = 4194304);
                ...
                l: {
                    ...
                    if (a && a.rangeCount !== 0) {
                        ...
                        var f = 0
                          ...
                          , h = null;
                        t: for (; ; ) {
                            for (var r; E !== u || e !== 0 && E.nodeType !== 3 || (c = f + e),
    ...
    function $s(l, t, u) {
        ...
        case 13:
            ...
            l !== null && (u = dy.bind(null, u),
            qy(l, u))));
            break;
        case 22:
            if (a = u.memoizedState !== null || Zt,
            !a) {
    ...
    function ks(l, t, u) {
        ...
        case 18:
            ml !== null && (Kl ? (l = ml,
            V1(l.nodeType === 9 ? l.body : l.nodeName === "HTML" ? l.ownerDocument.body : l, u.stateNode),
            _a(l)) : V1(ml, u.stateNode));
            break;
        case 4:
            a = ml,
            e = Kl,
    ...
    function fy(l) {
        ...
        case 19:
            var t = l.stateNode;
            return t === null && (t = l.stateNode = new Ws),
            t;
        case 22:
            return l = l.stateNode,
            t = l._retryCache,
    ...
    function l1(l, t) {
            ...
            a & 4) {
                ...
                u === null)
                    if (a === null)
                        if (l.stateNode === null) {
                            l: {
                                ...
                                case "title":
                                    ...
                                    (!n || n[Na] || n[Nl] || n.namespaceURI === "http://www.w3.org/2000/svg" || n.hasAttribute("itemprop")) && (n = e.createElement(a),
                                ...
                                case "link":
                                    ...
                                    break;
                                case "meta":
                                    if (f = lv("meta", "content", e).get(a + (u.content || ""))) {
                        ...
                        l.stateNode = P1(e, a, l.memoizedProps);
                else
                    n !== a ? (n === null ? u.stateNode !== null && (u = u.stateNode,
                    u.parentNode.removeChild(u)) : n.count--,
                    a === null ? tv(e, l.type, l.stateNode) : P1(e, a, l.memoizedProps)) : a === null && l.stateNode !== null && Ec(l, l.memoizedProps, u.memoizedProps)
            }
            break;
        case 27:
            Jl(t, l),
            wl(l),
            a & 512 && (Ol || u === null || Dt(u, u.return)),
            u !== null && a & 4 && Ec(l, l.memoizedProps, u.memoizedProps);
            break;
        case 5:
            if (Jl(t, l),
            wl(l),
            ...
            Ec(l, e, u !== null ? u.memoizedProps : e)),
            a & 1024 && (Oc = !0);
            break;
        case 6:
            if (Jl(t, l),
        ...
        case 13:
            Jl(t, l),
            wl(l),
            l.child.flags & 8192 && l.memoizedState !== null != (u !== null && u.memoizedState !== null) && (rn = Fl()),
            a & 4 && (a = l.updateQueue,
            a !== null && (l.updateQueue = null,
            dn(l, a)));
            break;
    ...
    function u1(l, t, u, a) {
        ...
        case 22:
            n = t.stateNode,
            f = t.alternate,
            t.memoizedState !== null ? n._visibility & 2 ? zt(l, t, u, a) : ee(l, t) : n._visibility & 2 ? zt(l, t, u, a) : (n._visibility |= 2,
    ...
    function da(l, t, u, a, e) {
        ...
        t = t.child; t !== null; ) {
            ...
            case 22:
                var g = f.stateNode;
                f.memoizedState !== null ? g._visibility & 2 ? da(n, f, c, i, e) : ee(n, f) : (g._visibility |= 2,
                da(n, f, c, i, e)),
    ...
    function a1(l, t, u) {
        ...
        case 26:
            ha(l, t, u),
            l.flags & ne && l.memoizedState !== null && Jy(u, bt, l.memoizedState, l.memoizedProps);
            break;
        case 5:
            ha(l, t, u);
            break;
        ...
        case 22:
            ...
            a !== null && a.memoizedState !== null ? (a = ne,
            ne = 16777216,
            ha(l, t, u),
            ne = a) : ha(l, t, u));
            break;
    ...
    var cy = {
      ...
      , Rc = null;
    function nt() {
        return (P & 2) !== 0 && J !== 0 ? J & -J : b.T !== null ? Bc() : Oi()
    }
    function s1() {
        if (et === 0)
            if ((J & 536870912) === 0 || $) {
    ...
    function $l(l, t, u) {
        (l === il && (tl === 2 || tl === 9) || l.cancelPendingCommit !== null) && (ba(l, 0),
        yu(l, J, et, !1)),
        Ua(l, u),
        ((P & 2) === 0 || l !== il) && (l === il && ((P & 2) === 0 && (Xu |= u),
        gl === 4 && yu(l, J, et, !1)),
        Ut(l))
    }
    function v1(l, t, u) {
        ...
        do {
            if (e === 0) {
                ...
                l: {
                    ...
                    if ((t & 62914560) === t && (e = rn + 300 - Fl(),
                    10 < e)) {
                        if (yu(a, t, et, !iu),
                        pe(a, 0, !0) !== 0)
                            break l;
                        wt = t,
                        a.timeoutHandle = Q1(o1.bind(null, a, u, Wl, Sn, Uc, t, et, Xu, ga, iu, n, "Throttled", -0, 0), e);
                        break l
                    }
                    o1(a, u, Wl, Sn, Uc, t, et, Xu, ga, iu, n, null, -0, 0)
                }
            }
            break
        } while (!0);
    ...
    function o1(l, t, u, a, e, n, f, c, i, d, g, E, h, r) {
        ...
        E & 8192 || (E & 16785408) === 16785408) {
            ...
            a1(t, n, E);
            var D = (n & 62914560) === n ? rn - Fl() : (n & 4194048) === n ? c1 - Fl() : 0;
            if (D = wy(E, D),
            D !== null) {
                wt = n,
                l.cancelPendingCommit = D(b1.bind(null, l, t, n, u, a, e, f, c, i, g, E, null, h, r)),
                yu(l, n, f, !d);
                return
            }
        }
        b1(l, t, n, u, a, e, f, c, i)
    }
    function sy(l) {
        for (var t = l; ; ) {
            var u = t.tag;
    ...
    function y1(l, t) {
        ...
        t === ia || t === we ? (t = D0(),
        tl = 3) : t === Yf ? (t = D0(),
        tl = 4) : tl = t === oc ? 8 : t !== null && typeof t == "object" && typeof t.then == "function" ? 6 : 1,
        at = t,
        L === null && (gl = 1,
        cn(l, vt(t, l.current)))
    }
    function m1() {
        var l = tt.current;
        return l === null ? !0 : (J & 4194048) === J ? dt === null : (J & 62914560) === J || (J & 536870912) !== 0 ? l === dt : !1
    }
    function d1() {
        var l = b.H;
        return b.H = Pa,
    ...
    function zn() {
        gl = 4,
        iu || (J & 4194048) !== J && tt.current !== null || (ra = !0),
        (su & 134217727) === 0 && (Xu & 134217727) === 0 || il === null || yu(il, J, et, !1)
    }
    function qc(l, t, u) {
        var a = P;
        P |= 2;
    ...
    function za(l, t, u, a) {
        ...
        t.flags & 32768 ? ($ || a === 1 ? l = !0 : ra || (J & 536870912) !== 0 ? l = !1 : (iu = l = !0,
        (a === 2 || a === 9 || a === 3 || a === 6) && (a = tt.current,
            ...
            if ((t.subtreeFlags & 13878) !== 0 || u) {
                ...
                try {
                    ...
                    var n = Jc
                      ...
                      , c = n.focusedElem
                      , i = n.selectionRange;
                    if (f !== c && c && c.ownerDocument && n0(c.ownerDocument.documentElement, c)) {
                        if (i !== null && gf(c)) {
                            var d = i.start
                              , g = i.end;
                            if (g === void 0 && (g = d),
                            "selectionStart"in c)
                                ...
                                if (h.getSelection) {
                                    var r = h.getSelection()
                                      ...
                                      , fl = i.end === void 0 ? q : Math.min(i.end, D);
                                    !r.extend && q > fl && (f = fl,
                                    fl = q,
                                    q = f);
                                    var y = e0(c, q)
                                    ...
                                    if (y && s && (r.rangeCount !== 1 || r.anchorNode !== y.node || r.anchorOffset !== y.offset || r.focusNode !== s.node || r.focusOffset !== s.offset)) {
                                        ...
                                        r.removeAllRanges(),
                                        q > fl ? (r.addRange(m),
                                        r.extend(s.node, s.offset)) : (m.setEnd(s.node, s.offset),
                                        r.addRange(m))
                                    }
                                }
                            }
    ...
    function T1() {
        if (_l === 4 || _l === 3) {
            ...
            var l = ou
              ...
              , u = wt
              , a = i1;
            (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ? _l = 5 : (_l = 0,
            Sa = ou = null,
            A1(l, l.pendingLanes));
            ...
            Ut(l),
            e = l.pendingLanes,
            (u & 261930) !== 0 && (e & 42) !== 0 ? l === Rc ? ie++ : (ie = 0,
            Rc = l) : ie = 0,
            se(0)
        }
    }
    ...
    function my(l, t, u) {
        ...
        l.warmLanes &= ~u,
        il === l && (J & u) === u && (gl === 4 || gl === 3 && (J & 62914560) === J && 300 > Fl() - rn ? (P & 2) === 0 && ba(l, 0) : Dc |= u,
        ga === J && (ga = 0)),
        Ut(l)
    }
    function M1(l, t) {
            ...
            do
                for (var u = !1, a = An; a !== null; ) {
                    if (l !== 0) {
                        ...
                        n = J,
                        n = pe(a, a === il ? n : 0, a.cancelPendingCommit !== null || a.timeoutHandle !== -1),
                        (n & 3) === 0 || Da(a, n) || (u = !0,
                        N1(a, n));
                    a = a.next
                }
    ...
    function D1(l, t) {
        for (var u = l.suspendedLanes, a = l.pingedLanes, e = l.expirationTimes, n = l.pendingLanes & -62914561; 0 < n; ) {
            var f = 31 - Il(n)
              , c = 1 << f
              , i = e[f];
            i === -1 ? ((c & u) === 0 || (c & a) !== 0) && (e[f] = Vv(c, t)) : i <= t && (l.expiredLanes |= c),
            n &= ~c
        }
        if (t = il,
        u = J,
        ...
        a = l.callbackNode,
        u === 0 || l === t && (tl === 2 || tl === 9) || l.cancelPendingCommit !== null)
    ...
    function U1(l, t) {
        ...
        if (Tn() && l.callbackNode !== u)
            return null;
        var a = J;
        return a = pe(l, l === il ? a : 0, l.cancelPendingCommit !== null || l.timeoutHandle !== -1),
        a === 0 ? null : (v1(l, a, t),
        D1(l, Fl()),
        l.callbackNode != null && l.callbackNode === u ? U1.bind(null, l) : null)
    }
    function N1(l, t) {
        if (Tn())
            return null;
    ...
    function by(l, t, u, a, e) {
        if (t === "submit" && u && u.stateNode === e) {
            var n = H1((e[Vl] || null).action)
              , f = a.submitter;
            f && (t = (t = f[Vl] || null) ? H1(t.formAction) : f.getAttribute("formAction"),
            t !== null && (n = t,
            f = null));
    ...
    for (var Gc = 0; Gc < Ef.length; Gc++) {
        var Xc = Ef[Gc]
          , zy = Xc.toLowerCase()
          , Ey = Xc[0].toUpperCase() + Xc.slice(1);
        St(zy, "on" + Ey)
    }
    St(s0, "onAnimationEnd"),
    St(v0, "onAnimationIteration"),
    St(o0, "onAnimationStart"),
    St("dblclick", "onDoubleClick"),
    St("focusin", "onFocus"),
    St("focusout", "onBlur"),
    St(Yo, "onTransitionRun"),
    St(Bo, "onTransitionStart"),
    St(Go, "onTransitionCancel"),
    St(y0, "onTransitionEnd"),
    ...
    var ve = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" ")
      , Ty = new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(ve));
    function C1(l, t) {
        t = (t & 4) !== 0;
    ...
    function Zc(l) {
        if (!l[_n]) {
            ...
            pi.forEach(function(u) {
                u !== "selectionchange" && (Ty.has(u) || Qc(u, !1, l),
                Qc(u, !0, l))
            });
    ...
    function q1(l, t, u, a) {
        ...
        u = e.bind(null, t, u, l),
        e = void 0,
        !cf || t !== "touchstart" && t !== "touchmove" && t !== "wheel" || (e = !0),
        ...
        Gi(function() {
            ...
            l: {
                ...
                if (h !== void 0) {
                    ...
                    for (var s = d, m; s !== null; ) {
                        ...
                        if (m = z.stateNode,
                        z = z.tag,
                        z !== 5 && z !== 26 && z !== 27 || m === null || y === null || (z = Ra(s, y),
                        z != null && q.push(oe(s, z, m))),
                        fl)
                            break;
                        s = s.return
                    }
                    0 < q.length && (h = new r(h,D,null,u,g),
                    E.push({
                        event: h,
                        listeners: q
                    }))
            ...
            if ((t & 7) === 0) {
                l: {
                    ...
                    h && u !== ef && (D = u.relatedTarget || u.fromElement) && (Vu(D) || D[Zu]))
                        break l;
                    ...
                    D !== null && (fl = Y(D),
                    q = D.tag,
                    D !== fl || q !== 5 && q !== 27 && q !== 6) && (D = null)) : (r = null,
                    D = d),
                    r !== D)) {
                        if (q = Zi,
                        z = "onMouseLeave",
                        y = "onMouseEnter",
                        s = "mouse",
                        (l === "pointerout" || l === "pointerover") && (q = Li,
                        z = "onPointerLeave",
                        y = "onPointerEnter",
                        s = "pointer"),
                        fl = r == null ? h : Ha(r),
                        m = D == null ? h : Ha(D),
                        h = new q(z,s + "leave",r,u,g),
                        h.target = fl,
                        h.relatedTarget = m,
                        z = null,
                        Vu(g) === d && (q = new q(y,s + "enter",D,u,g),
                        q.target = m,
                        q.relatedTarget = fl,
                        z = q),
                        fl = z,
                ...
                l: {
                    ...
                    r === "select" || r === "input" && h.type === "file")
                        ...
                        r = h.nodeName,
                        !r || r.toLowerCase() !== "input" || h.type !== "checkbox" && h.type !== "radio" ? d && af(d.elementType) && (k = Ii) : k = Co;
                    if (k && (k = k(l, d))) {
                        ki(E, k, u, g);
                        break l
                    }
                    H && H(l, h, d),
                    l === "focusout" && d && h.type === "number" && d.memoizedProps.value != null && uf(h, "number", h.value)
                }
                switch (H = d ? Ha(d) : window,
                l) {
                case "focusin":
                    (Fi(H) || H.contentEditable === "true") && (Iu = H,
                    Sf = d,
                    Xa = null);
                    break;
                case "focusout":
                ...
                if (df)
                    ...
                    ku ? Wi(l, u) && (w = "onCompositionEnd") : l === "keydown" && u.keyCode === 229 && (w = "onCompositionStart");
                w && (Ki && u.locale !== "ko" && (ku || w !== "onCompositionStart" ? w === "onCompositionEnd" && ku && (Z = Xi()) : (kt = g,
                sf = "value"in kt ? kt.value : kt.textContent,
                ku = !0)),
                H = Mn(d, w),
                0 < H.length && (w = new Vi(w,l,null,u,g),
                E.push({
                    event: w,
                    listeners: H
                }),
                Z ? w.data = Z : (Z = $i(u),
                Z !== null && (w.data = Z)))),
                (Z = Mo ? po(l, u) : Do(l, u)) && (w = Mn(d, "onBeforeInput"),
                0 < w.length && (H = new Vi("onBeforeInput","beforeinput",null,u,g),
                E.push({
                    event: H,
                    listeners: w
                }),
    ...
    function j1(l, t, u, a, e) {
        for (var n = t._reactName, f = []; u !== null && u !== a; ) {
            ...
            e ? (d = Ra(u, n),
            d != null && f.unshift(oe(u, d, i))) : e || (d = Ra(u, n),
            d != null && f.push(oe(u, d, i)))),
            u = u.return
        }
        f.length !== 0 && l.push({
            event: t,
...
`).replace(_y, "")
    ...
    function nl(l, t, u, a, e, n) {
        ...
        case "formAction":
            if (typeof a == "function") {
                ...
                typeof n == "function" && (u === "formAction" ? (t !== "input" && nl(l, t, "name", e.name, e, null),
                nl(l, t, "formEncType", e.formEncType, e, null),
                nl(l, t, "formMethod", e.formMethod, e, null),
                nl(l, t, "formTarget", e.formTarget, e, null)) : (nl(l, t, "encType", e.encType, e, null),
        ...
        case "textContent":
            break;
        default:
            (!(2 < u.length) || u[0] !== "o" && u[0] !== "O" || u[1] !== "n" && u[1] !== "N") && (u = Iv.get(u) || u,
            De(l, u, a))
        }
    }
        ...
        default:
            if (af(t)) {
                for (g in u)
                    ...
                    a !== void 0 && Lc(l, t, g, a, u, void 0));
                return
            }
        }
        for (c in u)
            u.hasOwnProperty(c) && (a = u[c],
            a != null && nl(l, t, c, a, u, null))
    }
    function My(l, t, u, a) {
        switch (t) {
        case "div":
            ...
            for (r in u) {
                ...
                if (u.hasOwnProperty(r) && E != null)
                    ...
                    case "defaultValue":
                        i = E;
                    default:
                        a.hasOwnProperty(r) || nl(l, t, r, null, a, E)
                    }
            }
            for (var h in a) {
                var r = a[h];
                if (E = u[h],
                a.hasOwnProperty(h) && (r != null || E != null))
                    switch (h) {
                    case "type":
                        n = r;
                        break;
        ...
        case "select":
            ...
            u = f,
            a = r,
            h != null ? wu(l, !!u, h, !1) : !!a != !!u && (t != null ? wu(l, !!u, t, !0) : wu(l, !!u, u ? [] : "", !1));
            return;
        case "textarea":
            r = h = null;
            for (c in u)
        ...
        case "menuitem":
            for (var q in u)
                h = u[q],
                u.hasOwnProperty(q) && h != null && !a.hasOwnProperty(q) && nl(l, t, q, null, a, h);
            for (d in a)
                if (h = a[d],
                r = u[d],
                a.hasOwnProperty(d) && h !== r && (h != null || r != null))
                    switch (d) {
                    case "children":
                    case "dangerouslySetInnerHTML":
                        if (h != null)
        ...
        default:
            if (af(t)) {
                for (var fl in u)
                    h = u[fl],
                    u.hasOwnProperty(fl) && h !== void 0 && !a.hasOwnProperty(fl) && Lc(l, t, fl, void 0, a, h);
                for (g in a)
                    h = a[g],
                    r = u[g],
                    !a.hasOwnProperty(g) || h === r || h === void 0 && r === void 0 || Lc(l, t, g, h, a, r);
                return
            }
        }
        for (var y in u)
            h = u[y],
            u.hasOwnProperty(y) && h != null && !a.hasOwnProperty(y) && nl(l, t, y, null, a, h);
        for (E in a)
            h = a[E],
            r = u[E],
            !a.hasOwnProperty(E) || h === r || h == null && r == null || nl(l, t, E, h, a, r)
    }
    function B1(l) {
        switch (l) {
        case "css":
    ...
    var Q1 = typeof setTimeout == "function" ? setTimeout : void 0
      ...
      , Ny = typeof queueMicrotask == "function" ? queueMicrotask : typeof Z1 < "u" ? function(l) {
        return Z1.resolve(null).then(l).catch(Hy)
    }
    : Q1;
    function Hy(l) {
        setTimeout(function() {
            ...
            e && e.nodeType === 8)
                ...
                u === "/$" || u === "/&") {
                    ...
                    for (var n = u.firstChild; n; ) {
                        var f = n.nextSibling
                          , c = n.nodeName;
                        n[Na] || c === "SCRIPT" || c === "STYLE" || c === "LINK" && n.rel.toLowerCase() === "stylesheet" || u.removeChild(n),
                        n = f
                    }
                } else
    ...
    function Gy(l, t, u) {
        ...
        if (a && l && t) {
            ...
            t === "image" && u && u.imageSrcSet ? (e += '[imagesrcset="' + it(u.imageSrcSet) + '"]',
            typeof u.imageSizes == "string" && (e += '[imagesizes="' + it(u.imageSizes) + '"]')) : e += '[href="' + it(l) + '"]';
            var n = e;
            switch (t) {
            case "style":
                n = Aa(l);
            ...
            rt.set(n, l),
            a.querySelector(e) !== null || t === "style" && a.querySelector(me(n)) || t === "script" && a.querySelector(de(n)) || (t = a.createElement("link"),
            ql(t, "link", l),
            pl(t),
            a.head.appendChild(t)))
        }
    ...
    function k1(l, t, u, a) {
        ...
        case "title":
            return null;
        case "style":
            return typeof u.precedence == "string" && typeof u.href == "string" ? (t = Aa(u.href),
        ...
        case "script":
            return t = u.async,
            u = u.src,
            typeof u == "string" && t && typeof t != "function" && typeof t != "symbol" ? (t = Oa(u),
    ...
    function lv(l, t, u) {
        ...
        e = 0; e < u.length; e++) {
            var n = u[e];
            if (!(n[Na] || n[Nl] || l === "link" && n.getAttribute("rel") === "stylesheet") && n.namespaceURI !== "http://www.w3.org/2000/svg") {
    ...
    var ti = 0;
    function wy(l, t) {
        return l.stylesheets && l.count === 0 && Cn(l, l.stylesheets),
        0 < l.count || 0 < l.imgCount ? function(u) {
            var a = setTimeout(function() {
                if (l.stylesheets && Cn(l, l.stylesheets),
                l.unsuspend) {
                    var n = l.unsuspend;
                    l.unsuspend = null,
                    n()
            ...
            0 < l.imgBytes && ti === 0 && (ti = 62500 * py());
            var e = setTimeout(function() {
                if (l.waitingForImages = !1,
                l.count === 0 && (l.stylesheets && Cn(l, l.stylesheets),
                l.unsuspend)) {
                    var n = l.unsuspend;
                    l.unsuspend = null,
                    n()
    ...
    function av(l, t, u, a, e, n, f, c, i, d, g, E) {
        return l = new $y(l,t,u,f,i,d,g,E,c),
        t = 1,
        n === !0 && (t |= 24),
        n = lt(3, null, null, t),
        l.current = n,
    ...
    function ui(l, t) {
        fv(l, t),
        (l = l.alternate) && fv(l, t)
    }
    function cv(l) {
        if (l.tag === 13 || l.tag === 31) {
            var t = Du(l, 67108864);
            t !== null && $l(t, l, 67108864),
            ui(l, 67108864)
        }
    }
    function iv(l) {
    ...
    var fi = !1
      ...
      , ge = new Map
      , Su = []
      , Iy = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");
    function vv(l, t) {
        switch (l) {
        case "focusin":
        case "focusout":
    ...
    function Py(l, t, u, a, e) {
        ...
        case "focusin":
            ...
            !0;
        case "dragenter":
            return ru = Se(ru, l, t, u, a, e),
            !0;
        case "mouseover":
            return gu = Se(gu, l, t, u, a, e),
            !0;
        case "pointerover":
            var n = e.pointerId;
            return re.set(n, Se(re.get(n) || null, l, t, u, a, e)),
            !0;
        case "gotpointercapture":
            return n = e.pointerId,
            ge.set(n, Se(ge.get(n) || null, l, t, u, a, e)),
            !0
        }
        return !1
    }
    ...
    function Yn(l, t) {
        ...
        S.unstable_scheduleCallback(S.unstable_NormalPriority, lm)))
    }
    var Bn = null;
    function mv(l) {
        Bn !== l && (Bn = l,
    ...
    function _a(l) {
        ...
        for (; 0 < Su.length && (u = Su[0],
        u.blockedOn === null); )
            ov(u),
            u.blockedOn === null && Su.shift();
    ...
    Gn.prototype.render = ci.prototype.render = function(l) {
    ...
    ,
    Gn.prototype.unmount = ci.prototype.unmount = function() {
        var l = this._internalRoot;
        if (l !== null) {
            this._internalRoot = null;
            var t = l.containerInfo;
            nv(l.current, 2, null, l, null, null),
            bn(),
            t[Zu] = null
        }
    }
    ...
    return ze.createRoot = function(l, t) {
        ...
        t = av(l, 1, !1, null, null, u, a, null, e, n, f, dv),
        l[Zu] = t.current,
        Zc(l),
        new ci(t)
    }
    ...
    ze.hydrateRoot = function(l, t, u) {
        ...
        t = av(l, 1, !0, t, u ?? null, a, e, i, n, f, c, dv),
        t.context = ev(null),
        u = t.current,
        a = nt(),
        a = Fn(a),
...
var Uv = {
  ...
  , Mv = zu.createContext && zu.createContext(Uv)
  , dm = ["attr", "size", "title"];
function hm(S, U) {
    if (S == null)
        return {};
    ...
    if (Object.getOwnPropertySymbols) {
        ...
        for (C = 0; C < Y.length; C++)
            o = Y[C],
            !(U.indexOf(o) >= 0) && Object.prototype.propertyIsEnumerable.call(S, o) && (M[o] = S[o])
    }
    return M
}
function rm(S, U) {
...
function Zn(S) {
    for (var U = 1; U < arguments.length; U++) {
        ...
        U % 2 ? pv(Object(M), !0).forEach(function(o) {
            gm(S, o, M[o])
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(S, Object.getOwnPropertyDescriptors(M)) : pv(Object(M)).forEach(function(o) {
...
function Nv(S) {
    return S && S.map( (U, M) => zu.createElement(U.tag, Zn({
        key: M
    }, U.attr), Nv(U.child)))
}
function Hv(S) {
    return U => zu.createElement(zm, Qn({
        attr: Zn({}, S.attr)
    }, U), Nv(S.child))
}
function zm(S) {
    var U = M => {
        var {attr: o, size: C, title: Y} = S, sl = hm(S, dm), hl = C || M.size || "1em", p;
        return M.className && (p = M.className),
        S.className && (p = (p ? p + " " : "") + S.className),
        zu.createElement("svg", Qn({
            stroke: "currentColor",
            fill: "currentColor",
            strokeWidth: "0"
        }, M.attr, o, sl, {
        ...
        }), Y && zu.createElement("title", null, Y), S.children)
    }
    ;
    return Mv !== void 0 ? zu.createElement(Mv.Consumer, null, M => U(M)) : U(Uv)
}
function Em(S) {
    return Hv({
        attr: {
...
const Am = () => Q.jsxs("div", {
    className: "text-center flex flex-col items-center gap-6 z-10",
    children: [Q.jsxs("div", {
        className: "space-y-2",
        children: [Q.jsx("h1", {
            ...
            className: "text-nobis-muted font-mono text-sm md:text-base",
            children: "External Roblox Executor for Windows."
        })]
    }), Q.jsxs("div", {
        className: "flex items-center gap-4 mt-4",
        children: [Q.jsxs("a", {
            href: "https://github.com/showzayn/Nobis/raw/refs/heads/main/NobisBootstrapper.exe",
            target: "_blank",
            rel: "noopener noreferrer",
            className: "flex items-center gap-2 bg-white text-black px-6 py-2 rounded text-sm font-medium hover:bg-gray-200 transition-colors",
            children: [Q.jsx(Tm, {}), Q.jsx("span", {
                children: "Download Build"
            })]
        }), Q.jsxs("a", {
            href: "https://discord.gg/cv6wGptZNa",
            target: "_blank",
            rel: "noopener noreferrer",
            className: "flex items-center gap-2 px-6 py-2 rounded text-sm font-medium text-nobis-muted hover:text-white transition-colors border border-transparent hover:border-nobis-border",
            children: [Q.jsx(Em, {}), Q.jsx("span", {
                children: "Discord Server"
            })]
        })]
    })]
})
  , Om = ({imageSrc: S, altText: U="Preview image", captionText: M="Hover to explore", showMobileWarning: o=!0, showTooltip: C=!1, hoverScale: Y=1.02, rotateAmplitude: sl=8}) => {
    const hl = Ee.useRef(null)
      , p = Ee.useRef(null)
      , A = Ee.useRef(null);
    function F(Ml) {
        if (!hl.current || !p.current)
            return;
        const dl = hl.current.getBoundingClientRect()
          , Ul = Ml.clientX - dl.left - dl.width / 2
          , Yl = -(Ml.clientY - dl.top - dl.height / 2) / (dl.height / 2) * sl
          , Tt = Ul / (dl.width / 2) * sl;
        p.current.style.transform = `rotateX(${Yl}deg) rotateY(${Tt}deg) scale(${Y})`,
        A.current && (A.current.style.opacity = "1",
        A.current.style.transform = `translate(${Ml.clientX - dl.left}px, ${Ml.clientY - dl.top}px) translate(-50%, -50%)`)
    }
    function j() {
        p.current && (p.current.style.transition = "transform 120ms ease-out")
    }
    function vl() {
        p.current && (p.current.style.transform = "rotateX(0deg) rotateY(0deg) scale(1)"),
        A.current && (A.current.style.opacity = "0")
    }
    return Q.jsxs("figure", {
        ref: hl,
        ...
        children: [o && Q.jsx("div", {
            ...
            children: "Tilt effect works best on desktop."
        }), Q.jsx("div", {
  ...
  , _m = () => Q.jsx(Om, {
    imageSrc: "./assets/nobis-preview.png",
  ...
  , Mm = () => Q.jsx("footer", {
    ...
    children: Q.jsxs("p", {
        className: "text-nobis-muted/40 text-xs font-mono",
        children: ["© ", new Date().getFullYear(), " Nobis."]
    })
})
  , pm = () => {
    const S = [{
        q: "Why won't it run?",
        a: "Download C++ Redistributable, and Node.js."
    }, {
        q: "How much UNC?",
        a: "Around 55%."
    }]
      , [U,M] = Ee.useState(0);
    return Q.jsxs("div", {
        className: "min-h-screen flex flex-col items-center selection:bg-nobis-blue selection:text-white font-sans overflow-x-hidden",
        children: [Q.jsxs("main", {
            className: "w-full max-w-7xl px-6 pt-20 pb-12 flex flex-col items-center gap-16",
            children: [Q.jsx(Am, {}), Q.jsx("section", {
                className: "w-full flex justify-center perspective-1000",
                children: Q.jsxs("div", {
                    className: "w-full max-w-4xl relative group",
                    children: [Q.jsx("div", {
                        className: "absolute -inset-1 bg-gradient-to-b from-nobis-blue/10 to-transparent rounded-xl blur-xl opacity-50 group-hover:opacity-75 transition duration-500"
                    }), Q.jsx(_m, {})]
                })
            }), Q.jsxs("section", {
                className: "w-full max-w-5xl mt-12 border-t border-nobis-border pt-12",
                children: [Q.jsxs("div", {
                    className: "flex items-center gap-3 mb-6",
                    children: [Q.jsx("div", {
                        className: "h-10 w-10 rounded-full bg-nobis-blue/10 border border-nobis-border flex items-center justify-center text-white font-semibold",
                        children: "?"
                    }), Q.jsx("h3", {
                    ...
                    children: S.map( (o, C) => {
                        ...
                        return Q.jsxs("button", {
                            onClick: () => M(Y ? null : C),
                            className: `relative text-left overflow-hidden rounded-lg border transition-all duration-200 ${Y ? "border-nobis-blue/60 bg-[#0d0d11]" : "border-nobis-border bg-[#0b0b0e]"} shadow-[0_10px_24px_rgba(0,0,0,0.28)] hover:border-nobis-blue/40 focus:outline-none`,
                            children: [Q.jsx("div", {
                                className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-nobis-blue/60 via-white/20 to-nobis-blue/60 opacity-70"
                            }), Q.jsxs("div", {
                                className: "p-5 flex items-start gap-3",
                                children: [Q.jsx("div", {
                                    className: `mt-1 h-2 w-2 rounded-full ${Y ? "bg-nobis-blue" : "bg-nobis-border"} transition-colors`
                                }), Q.jsxs("div", {
                                    className: "flex-1",
                                    children: [Q.jsx("p", {
                                        ...
                                        className: `font-mono text-sm text-nobis-muted mt-2 transition-[max-height,opacity] duration-200 ease-out ${Y ? "opacity-100 max-h-24" : "opacity-70 max-h-0 overflow-hidden"}`,
                                        children: o.a
                                    })]
                                }), Q.jsx("span", {
                                    className: `text-nobis-muted text-xs ml-2 transition-transform ${Y ? "rotate-45" : ""}`,
                                    children: "+"
                                })]
                            })]
                        }, o.q)
